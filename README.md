...
## 2. Stage 2 - Create the CI / CD pipeline for [DevOps-360-react app](https://github.com/Lowess/devops-360-react) withg Drone

### 2.1. Integrate the Webapp repository with Drone
...
### 2.2. Write the CI steps for the pipeline
...
### 2.2. Write the CD steps for the pipeline
...
### 2.3. Write the CDD steps for the pipeline
